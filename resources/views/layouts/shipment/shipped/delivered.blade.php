    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="btn-group mr-1">
                ...
                <button class="btn border mr-1" id=createReturn>Create Return</button>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="mb-0 text-sm">Stamps</span>
                                                    </div>
                                                </div>
                                            </th>
                                            <td>Ship2way Support</td>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="mb-0 text-sm">Facebook</span>
                                                    </div>
                                                </div>
                                            </th>
                                            <td>Ship2way Support</td>
