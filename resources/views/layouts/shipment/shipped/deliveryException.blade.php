              ...
              <div class="row">
                <div class="col-12">
                  <div class="btn-group" data-toggle="button" role="group">
                    ...
                    <button type="button" class="btn dropdown-toggle" data-toggle="dropdown">Customers</button>
                    <div class="dropdown-menu" role="menu">
                      <a class="dropdown-item" href="#">Siddhant</a>
                    ...
                    <td><span class="badge badge-dark">CSV 126</td>
                      <th scope="row">
                        <div class="media align-items-center">
                          ...
                          <div class="media-body">
                            <span class="mb-0 text-sm">Amazon.com</span>
                          </div>
                        </div>
                      </th>
                    <td>Shipstation Support</td>
