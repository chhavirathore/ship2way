            ...
            <table id="recent_shipments" class="table align-items-center table-flush order-column">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Suman</td>
                  <td>878979</td>
                  <td><span class="badge badge-info" data-toggle="modal" data-target="#new_user">Click to See Werehouse Detail</span></td>
                  <td>5</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>Rajesh</td>
                    <td>878979</td>
                    <td><span class="badge badge-info" data-toggle="modal" data-target="#new_user">Click to See Werehouse Detail</button></td>
                    <td>5</td>
                  </tr>                <tr>
                    <td>
                      <div class="form-check">
